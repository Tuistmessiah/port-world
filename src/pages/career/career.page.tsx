...
// import { ReactComponent as AngularSvg } from '../../assets/svgs/angular-svgrepo-com.svg';
    ...
    return (
        <div className={s('container')}>
            <div className={s('timeline')}>
                <div className={s('timeline-container primary')}>
                    <div className={s('timeline-icon')}>{/* <AngularSvg /> */}</div>
                    <div className={s('timeline-body')}>
                        <h4 className={s('timeline-title')}>
                            <span className={s('badge')}>Primary</span>
                        </h4>
                        <p>
                ...
                <div className={s('timeline-container danger')}>
                    ...
                    <div className={s('timeline-body')}>
                        <h4 className={s('timeline-title')}>
                            <span className={s('badge')}>Danger</span>
                        </h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam necessitatibus numquam earum ipsa fugiat veniam suscipit, officiis repudiandae, eum recusandae neque
                            dignissimos. Cum fugit laboriosam culpa, repellendus esse commodi deserunt.
                ...
                <div className={s('timeline-container success')}>
                    <div className={s('timeline-icon')}>
                        <i className={s('far fa-grin-tears')}></i>
                    </div>
                    <div className={s('timeline-body')}>
                        <h4 className={s('timeline-title')}>
                            <span className={s('badge')}>Success</span>
                        </h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam necessitatibus numquam earum ipsa fugiat veniam suscipit, officiis repudiandae, eum recusandae neque
                            dignissimos. Cum fugit laboriosam culpa, repellendus esse commodi deserunt.
                ...
                <div className={s('timeline-container warning')}>
                    <div className={s('timeline-icon')}>
                        <i className={s('far fa-grimace')}></i>
                    </div>
                    <div className={s('timeline-body')}>
                        <h4 className={s('timeline-title')}>
                            <span className={s('badge')}>Warning</span>
                        </h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam necessitatibus numquam earum ipsa fugiat veniam suscipit, officiis repudiandae, eum recusandae neque
                            dignissimos. Cum fugit laboriosam culpa, repellendus esse commodi deserunt.
                ...
                <div className={s('timeline-container')}>
                    ...
                    <div className={s('timeline-body')}>
                        <h4 className={s('timeline-title')}>
                            <span className={s('badge')}>Secondary</span>
                        </h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam necessitatibus numquam earum ipsa fugiat veniam suscipit, officiis repudiandae, eum recusandae neque
                            dignissimos. Cum fugit laboriosam culpa, repellendus esse commodi deserunt.
                ...
                <div className={s('timeline-container info')}>
                    <div className={s('timeline-icon')}>
