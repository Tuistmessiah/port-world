                        ...
                        <FadeInSection>
                            ...
                            >
                                ...
                                <p>
                                    ...
                                    data streams and dependencies. My expertise was instrumental in untangling and streamlining this complex web of information, ensuring data cohesion and seamless
                                    inter-departmental interactions. By integrating advanced full-stack technologies, I engineered an intuitive and efficient user interface that significantly enhanced
                                ...
                                <p>
                                    ...
                                    cross-functional team, which encompassed the CEO, departmental managers, and the development squad. Through these synergies, we achieved a holistic understanding of
                                    the organization's needs and objectives. This collaborative endeavor not only produced a system that met the company's strategic goals but also established a
                                    benchmark for organizational efficiency and user-centric design.
                                </p>
                                <ul className={s('tech-pills')}>
                        ...
                        <FadeInSection>
                            ...
                            >
                                ...
                                <p>
                                    ...
                                    pivotal to this mission. Recognizing the evolving needs of the platform and the advantages of modern technologies, I spearheaded a comprehensive overhaul of the
                                    app, transitioning from React to TypeScript coupled with Hooks. This move was instrumental in enhancing the app's maintainability, scalability, and performance.
                                </p>
                                <p>
                                    ...
                                    service, automating key communications and enhancing stakeholder engagement. Through these multifaceted contributions, I substantially contributed to the startup's
                                    goal of reshaping the Dutch healthcare freelancing landscape.
                                </p>
                                <ul className={s('tech-pills')}>
                        ...
                        <FadeInSection>
                            ...
                            >
                                ...
                                <p>
                                    ...
                                    LeafletJS. The technological diversity didn't end there; I also acquired hands-on experience with Angular, VueJS, and NestJS, broadening the application's reach and
                                    capability.
                                </p>
                                <p>
                                    Starting with an agile team of two, we've since doubled in size, reflecting the project's growth and the increasing complexities it presented. As the team expanded,
                                    I naturally gravitated towards a leadership role, particularly concerning frontend responsibilities. I've passionately mentored and guided more junior developers,
                                    ensuring best practices, knowledge transfer, and the consistent delivery of high-quality code. While my primary focus remained on frontend development, I embraced
                                    the opportunity to delve into threejs during our endeavors with a backoffice application, further diversifying my skill set and contributing to the project's
                                    multifaceted nature.
                                </p>
                                <ul className={s('tech-pills')}>
